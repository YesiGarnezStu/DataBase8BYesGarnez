...
def insert_02():
    ...
    cursor.execute("""
        ...
        VALUES ('Historia del Arte', 'Historia y apreciación artística', 3)
    """)
    conn.commit()
...
def insert_04():
    ...
    cursor.execute("""
        INSERT INTO estudiantes (nombre, apellido, email, fecha_nacimiento)
        VALUES 
        ('Valentina', 'Ruiz', 'valentina.ruiz@email.com', '2003-05-10'),
        ('Mateo', 'Torres', 'mateo.torres@email.com', '2002-11-20')
    """)
    conn.commit()
